...
module.exports = {
  ...
  rules: {
    ...
    "rule-empty-line-before": "never", // Require or disallow an empty line before rules "always": always require an empty line, "never": never allow an empty line, "always-multi-line": always require an empty line for multi-line rules, "never-multi-line": never allow an empty line for multi-line rules
